...
#include "three_ds_recomp/legacy/controller/controldevice/controller/Controller.h"
#include "three_ds_recomp/legacy/controller/controldevice/controller/mapping/ControllerDefaultMappings.h"
#include "ship/utils/StringHelper.h"
#include <imgui.h>
#include "ship/controller/controldevice/controller/mapping/mouse/WheelHandler.h"

namespace ThreeDsRecomp::Legacy {
...
ControlDeck::ControlDeck(std::vector<CONTROLLERBUTTONS_T> additionalBitmasks)
    : ControlDeck(additionalBitmasks, std::make_shared<ThreeDsRecomp::Legacy::ControllerDefaultMappings>(),
