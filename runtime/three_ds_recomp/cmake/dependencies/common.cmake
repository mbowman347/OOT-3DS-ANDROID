...
set(STB_IMPLEMENTATION_SOURCE ${STB_DIR}/stb_impl.c)
...
set(STB_IMPLEMENTATION_CONTENT "#define STB_IMAGE_IMPLEMENTATION\n#include \"stb_image.h\"")
set(STB_IMPLEMENTATION_CURRENT "")
if(EXISTS "${STB_IMPLEMENTATION_SOURCE}")
    file(READ "${STB_IMPLEMENTATION_SOURCE}" STB_IMPLEMENTATION_CURRENT)
endif()
if(NOT STB_IMPLEMENTATION_CURRENT STREQUAL STB_IMPLEMENTATION_CONTENT)
    file(WRITE "${STB_IMPLEMENTATION_SOURCE}" "${STB_IMPLEMENTATION_CONTENT}")
endif()
